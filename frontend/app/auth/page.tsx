...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-purple-900/20 dark:to-slate-800 center-content">
      <div className="container max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Sign in to continue your writing journey</p>
        </div>

        <Card className="hover-lift bg-gradient-to-br from-white to-blue-50/50 dark:from-slate-800 dark:to-purple-900/20">
          <CardHeader>
            <CardTitle className="text-center">🚀 Get Started</CardTitle>
            <CardDescription className="text-center">Join thousands of writers enhancing their craft</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6">
              ...
              <Button variant="outline" className="w-full mt-4 hover-lift bg-transparent" onClick={handleAuth}>
