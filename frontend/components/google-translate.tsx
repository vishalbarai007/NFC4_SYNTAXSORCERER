    ...
    const initializeTranslate = () => {
      try {
        ...
        const removeGoogleElements = () => {
          try {
            const googleElements = [".goog-te-banner-frame", ".goog-logo-link", ".goog-te-balloon-frame"]
        ...
        window.googleTranslateElementInit = () => {
          try {
            if (window.google && window.google.translate) {
              ...
              setTimeout(removeGoogleElements, 500)
            }
          } catch (error) {
    ...
    <div className="flex items-center">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="sm" className="hover-lift flex items-center gap-2 px-2 md:px-3">
        ...
        <DropdownMenuContent align="end" className="w-48">
          {languages.map((language) => (
            <DropdownMenuItem
              ...
              className={`flex items-center gap-3 ${currentLang === language.code ? "bg-primary/10" : ""}`}
            >
